...
def get_anim_sel_drop_down(selectorIndex):
    ...
    i = 0
    for anim_name in remote_control_cozmo.anim_names:  # pyright: ignore[reportOptionalMemberAccess]
        is_selected_item = (i == remote_control_cozmo.anim_index_for_key[selectorIndex])  # pyright: ignore[reportOptionalMemberAccess]
...
def handle_index_page():
    text_to_say = remote_control_cozmo.text_to_say if remote_control_cozmo else ""
    return '''
    <html>
        <head>
            ...
            <table>
                <tr>
                    ...
                    <td valign=top>
                        ...
                        <h3>Talk</h3>
                        <b>Space</b> : Say <input type="text" name="sayText" id="sayTextId" value="''' + text_to_say + '''" onchange=handleTextInput(this)>
                    </td>
                    <td width=30></td>
                    <td valign=top>
...
def get_annotated_image():
    image = remote_control_cozmo.cozmo.world.latest_image  # pyright: ignore[reportOptionalMemberAccess]
