...
class IFTTTRobot(cozmo.robot.Robot):
    ...
    async def get_in_position(self):
        ...
        if (self.lift_height.distance_mm > 45) or (self.head_angle.degrees < 40):  # pyright: ignore[reportOptionalOperand]
    ...
    def display_image_file_on_face(self, image_name):
        ...
        resized_image = image.resize(cozmo.oled_face.dimensions(), Image.Resampling.NEAREST)
