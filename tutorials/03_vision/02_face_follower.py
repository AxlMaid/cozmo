...
def follow_faces(robot: cozmo.robot.Robot):
    ...
    robot.move_lift(-3)
    robot.set_head_angle(cozmo.robot.MAX_HEAD_ANGLE).wait_for_completed()  # pyright: ignore[reportUnusedCoroutine]
    ...
    while True:
        ...
        if not (face_to_follow and face_to_follow.is_visible):  # pyright: ignore[reportAttributeAccessIssue]
        ...
        if turn_action:
            ...
            turn_action.wait_for_completed()  # pyright: ignore[reportUnusedCoroutine]
