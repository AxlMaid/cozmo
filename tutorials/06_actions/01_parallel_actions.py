...
face_image = face_image.resize(cozmo.oled_face.dimensions(), Image.Resampling.BICUBIC)
...
def example1_lift_head(robot: cozmo.robot.Robot):
    ...
    robot.set_head_angle(cozmo.robot.MIN_HEAD_ANGLE).wait_for_completed()  # pyright: ignore[reportUnusedCoroutine]
    robot.set_lift_height(0.0).wait_for_completed()  # pyright: ignore[reportUnusedCoroutine]
    ...
    action1.wait_for_completed()  # pyright: ignore[reportUnusedCoroutine]
    action2.wait_for_completed()  # pyright: ignore[reportUnusedCoroutine]
...
def example3_abort_one_action(robot: cozmo.robot.Robot):
    ...
    action3.wait_for_completed()  # pyright: ignore[reportUnusedCoroutine]
...
def example4_abort_all_actions(robot: cozmo.robot.Robot):
    ...
    robot.wait_for_all_actions_completed()  # pyright: ignore[reportUnusedCoroutine]
