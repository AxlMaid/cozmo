...
def cozmo_program(robot: cozmo.robot.Robot):
    ...
    robot.play_anim_trigger(cozmo.anim.Triggers.CubePounceLoseSession).wait_for_completed()  # pyright: ignore[reportUnusedCoroutine, reportAttributeAccessIssue]
    ...
    robot.play_anim_trigger(cozmo.anim.Triggers.CubePounceLoseSession, ignore_body_track=True).wait_for_completed()  # pyright: ignore[reportUnusedCoroutine, reportAttributeAccessIssue]
    ...
    robot.play_anim(name="anim_poked_giggle").wait_for_completed()  # pyright: ignore[reportUnusedCoroutine]
