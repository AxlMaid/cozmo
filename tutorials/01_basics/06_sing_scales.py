...
def cozmo_program(robot: cozmo.robot.Robot):
    ...
    robot.set_head_angle(degrees(-25.0)).wait_for_completed()  # pyright: ignore[reportUnusedCoroutine]
    ...
    for note in scales:
        robot.say_text(note, voice_pitch=voice_pitch, duration_scalar=0.3).wait_for_completed()  # pyright: ignore[reportUnusedCoroutine]
